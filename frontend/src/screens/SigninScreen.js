  ...
  return <div className="form">
    <form onSubmit={submitHandler} >
      <ul className="form-container">
        ...
        <li>
          <p className='toggle'> New to Shopstar?</p>
          <Link to={redirect === "/" ? "register" : "register?redirect=" + redirect} className='button secondary text-center'>Create your Shopstar account</Link>
        </li>
      </ul>
    </form>
  </div>
